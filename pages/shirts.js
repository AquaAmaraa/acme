...
export default function ShirtsPage() {
  ...
  const [selectedCollection, setSelectedCollection] = useState('Shirts');
  ...
  const sortOptions = [
    { name: 'Relevance', href: '/shirts' },
    { name: 'Trending', href: '/shirts?sort=trending-desc' },
    { name: 'Latest arrivals', href: '/shirts?sort=latest-desc' },
    { name: 'Price: Low to high', href: '/shirts?sort=price-asc' },
    { name: 'Price: High to low', href: '/shirts?sort=price-desc' }
  ];
